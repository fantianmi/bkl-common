...
//		if(request.getParameter("saveDir")!=null||request.getParameter("saveDir")!=""){
//			relativeUploadDir = request.getParameter("saveDir");
//		}
		...
		factory.setRepository(new File(absoluteUploadDir)); 
